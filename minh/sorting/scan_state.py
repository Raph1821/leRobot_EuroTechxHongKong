"""
Medicine Scan State Machine — from teammate's leRobot_EuroTechxHongKong repo.

Manages the lifecycle of a medicine scan:
  SCANNING → accumulates OCR results (name + expiration)
  WAITING_FOR_REMOVAL → waits for medicine to be removed from camera view
  → back to SCANNING for next item
"""
